...
namespace Core
{
    ...
    public partial class IntegerxportableSequence
    {
        ...
        public IntegerxportableSequence(Char[] Digit_ARRAY, Boolean answer_SIGN_is, Boolean answer_DEBUG_is)
        {
            ...
            deflect[0] = Integerxportable.IntegerxportableDigitSetSurface(Digit_ARRAY);
            ...
            integerx = new Integerxportable(inflect[0], inflect[1], answer_SIGN_is, answer_DEBUG_is);
